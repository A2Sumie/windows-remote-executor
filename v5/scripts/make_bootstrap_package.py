"""Build the WRE v5 Windows bootstrap package on the controller (macOS/Linux).

Output: `v5/release/wre-v<version>-windows-x64.zip` containing:
...
V5_ROOT = HERE.parent
NATIVE_SRC = V5_ROOT / "native"
SCRIPTS_SRC = V5_ROOT / "scripts"
RELEASE_DIR = V5_ROOT / "release"
...
def copy_v5_source(dest_wre: Path) -> None:
    # Copy v5 native source alongside python/ (already populated by the build).
