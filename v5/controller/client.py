...
v5: the dead `captureLimitBytes` request field is gone — the native side never
implemented it (v4 audit A6).
"""
...
def build_request(
    ...
    *,
    ...
    if timeout_seconds:
        # Recorded by the native side only; the real deadline is enforced here
        # on the controller via the SSH transport timeout (see V5.md).
